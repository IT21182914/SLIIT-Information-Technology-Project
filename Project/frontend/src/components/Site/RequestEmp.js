...
export default function RequestEmp() {
  ...
  <form class="bg-white shadow-md rounded px-8 pt-5 pb-8 mb-6">
    ...
    <div class="mb-4">
      ...
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="emp" type="number" placeholder="No of Employee"/>
    </div>
    <div class="flex items-center justify-between">
      <button class="bg-yellow-300 hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" onClick={RequestEmployee}>
        Submit
      </button>
    </div>
  </form>
